...
namespace Menge {
	...
	namespace Math {
		...
		MENGE_API map<size_t, Geometry2D*> createGeometrys(TiXmlElement* node, size_t shapeNumber ,const std::string& prefix = "");//新增功能,返回多个Geometry的map
		...
		MENGE_API AABBShape * createAABB(TiXmlElement* node, size_t index, const std::string& prefix = "");//增加的功能
