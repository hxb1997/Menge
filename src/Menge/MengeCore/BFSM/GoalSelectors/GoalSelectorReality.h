...
/*!
 *	@file		GoalSelectorReality.h
 *	@brief		GoalSelectorReality Matrix. 
 */

#ifndef __GOAL_SELECTOR_REALITY_H__
#define __GOAL_SELECTOR_REALITY_H__
...
namespace Menge {
	...
	namespace BFSM {
		 ...
		 */
		class MENGE_API MatrixGoalSelector : public SetGoalSelector {
		public:
			/*!
		 ...
		 */
		class MENGE_API MatrixGoalSelectorFactory : public SetGoalSelectorFactory {
		public:
			/*!
			 ...
			 */
			virtual const char * name() const { return "Reality"; }
		...
		protected:
			 ...
			 */
			GoalSelector * instance() const { return new MatrixGoalSelector(); }
		};
	}	// namespace BFSM
}	// namespace Menge
