...
#ifndef __MIN_HEAPPLUS_H__
#define __MIN_HEAPPLUS_H__
...
namespace ROAD {
	...
	public:
		 ...
		 */
		AStarMinHeapPlus( unsigned int * heap, float * data, bool * state, unsigned int * path,
					  size_t N );
